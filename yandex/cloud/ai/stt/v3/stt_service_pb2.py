...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "yandex.cloud.ai.stt.v3.stt_service_pb2", _globals
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GETRECOGNITIONREQUEST.fields_by_name[
        "operation_id"
    ]._serialized_options = b"\350\3071\001\212\3101\004<=50"
    _ASYNCRECOGNIZER.methods_by_name["RecognizeFile"]._options = None
    _ASYNCRECOGNIZER.methods_by_name[
        "RecognizeFile"
    ]._serialized_options = b'\262\322*\027\022\025google.protobuf.Empty\202\323\344\223\002\037"\032/stt/v3/recognizeFileAsync:\001*'
